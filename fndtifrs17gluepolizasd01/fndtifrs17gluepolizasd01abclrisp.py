...
THEN (SELECT COALESCE (INSU_HE.ANUAL_SAL, 0) FROM USINSUG01.INSURED_HE INSU_HE
      ...
      AND   INSU_HE.COMPANY  =  PC.USERCOMP
...
JOIN ( SELECT P.USERCOMP, P.COMPANY, P.CERTYPE, P.BRANCH, P.PRODUCT, PSP.SUB_PRODUCT, P.POLICY, CERT.CERTIF, P.TITULARC, P.EFFECDATE  
	   ...
	   JOIN USBI01."IFRS170_T_RAMOS_POR_TIPO_RIESGO" RTR on RTR."BRANCHCOM" = P.BRANCH and RTR."RISKTYPEN" = 1
	   WHERE P.CERTYPE = '2' 
...
AND (R.NULLDATE IS NULL OR R.NULLDATE > PC.EFFECDATE) LIMIT 100;
